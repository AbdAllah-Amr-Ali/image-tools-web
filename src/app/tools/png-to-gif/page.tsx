...
export default function PngToGif() {
            ...
            try {
                ...
                img.onload = () => {
                    ...
                    if (ctx) {
                        ...
                        setImageSrc(canvas.toDataURL("image/gif"));
                    }
    ...
    const downloadImage = () => {
        ...
        link.href = imageSrc;
        link.download = file ? `${file.name.replace(/\.[^/.]+$/, "")}.gif` : "image.gif";
            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold mb-4">
                        PNG to <span className="text-indigo-600">GIF</span>
                    </h1>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border">
                    {!imageSrc && !isProcessing ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-20">
                            ...
                            <p className="text-lg font-medium">Converting PNG...</p>
                        </div>
                    ) : (
