    ...
    const downloadImage = () => {
        ...
        img.onload = () => {
            ...
            if (ctx) {
                ...
                link.download = file ? `inverted-${file.name}` : "inverted-image.jpg";
            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold mb-4">
                        Invert <span className="text-purple-600">Colors</span>
                    </h1>
                    <p className="text-lg text-muted-foreground">
                        Invert all colors in your image (Negative effect).
                    </p>
                </div>
                    ...
                    {!imageSrc ? (
                        ...
                        <div className="flex flex-col items-center gap-8">
                            <div className="grid md:grid-cols-2 gap-8 w-full">
                                ...
                                <div className="space-y-2">
                                    <h3 className="text-center font-medium text-muted-foreground">Inverted</h3>
                                    <div className="relative rounded-xl overflow-hidden border bg-gray-50">
                                        {/* eslint-disable-next-line @next/next/no-img-element */}
                                        <img
                                            src={imageSrc}
                            ...
                            <div className="flex gap-4">
                                ...
                                <button
                                    ...
                                    className="bg-purple-600 text-white px-8 py-3 rounded-xl font-semibold hover:bg-purple-700 transition-colors flex items-center gap-2"
                                >
